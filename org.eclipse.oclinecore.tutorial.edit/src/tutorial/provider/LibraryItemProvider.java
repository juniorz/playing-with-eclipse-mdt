...
/**
 * This is the item provider adapter for a {@link tutorial.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TutorialPackage.Literals.LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TutorialPackage.Literals.LIBRARY__BOOKS);
			childrenFeatures.add(TutorialPackage.Literals.LIBRARY__LOANS);
			childrenFeatures.add(TutorialPackage.Literals.LIBRARY__MEMBERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TutorialPackage.Literals.LIBRARY__BOOKS,
				 TutorialFactory.eINSTANCE.createBook()));

		newChildDescriptors.add
			(createChildParameter
				(TutorialPackage.Literals.LIBRARY__LOANS,
				 TutorialFactory.eINSTANCE.createLoan()));

		newChildDescriptors.add
			(createChildParameter
				(TutorialPackage.Literals.LIBRARY__MEMBERS,
				 TutorialFactory.eINSTANCE.createMember()));
	}
