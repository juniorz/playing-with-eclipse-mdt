...
/**
 * This is the item provider adapter for a {@link tutorial.Book} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TutorialPackage.Literals.BOOK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCopiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Book_copies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Book_copies_feature", "_UI_Book_type"),
				 TutorialPackage.Literals.BOOK__COPIES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
