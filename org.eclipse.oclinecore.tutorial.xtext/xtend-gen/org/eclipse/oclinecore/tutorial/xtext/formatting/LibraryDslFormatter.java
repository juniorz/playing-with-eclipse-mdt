 ...
 * generated by Xtext
 */
package org.eclipse.oclinecore.tutorial.xtext.formatting;
...
public class LibraryDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private LibraryDslGrammarAccess _libraryDslGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._libraryDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._libraryDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._libraryDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._libraryDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._libraryDslGrammarAccess.getML_COMMENTRule();
